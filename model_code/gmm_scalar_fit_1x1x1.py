#!/usr/bin/env python3
# gmm_scalar_fit_1x1x1.py
#
# Fits a 1-D GMM at each scalar position (h, w, t) independently.
# Designed to run as 8 parallel SLURM jobs, each covering 16 H rows.
#
# Usage:
#   python gmm_scalar_fit_1x1x1.py --job_id 0   # h = 0..15
#   python gmm_scalar_fit_1x1x1.py --job_id 1   # h = 16..31
#   ...
#   python gmm_scalar_fit_1x1x1.py --job_id 7   # h = 112..127
#
...
#
# After all 8 jobs finish, run gmm_scalar_aggregate_1x1x1.py
...
if not sample_file.exists():
    raise FileNotFoundError(
        f"Missing: {sample_file}\nRun extract_training_scalars_1x1x1.py first."
    )
...
print("Run gmm_scalar_aggregate_1x1x1.py after all 8 jobs finish.")
